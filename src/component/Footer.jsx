    ...
    <div className="max-w[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300 ">
      <div>
        ...
        <p className="py-4">
          ...
          incidunt iure beatae fugiat, ea earum porro doloremque nulla
          cupiditate. Sapiente officiis temporibus ipsam veritatis autem!
        </p>
      ...
      <div className="lg:col-span-2 flex justify-between">
        ...
        <div>
          ...
          <ul>
            <li className="py-2 text-sm">Calm</li>
